...
const Rv_min, Rv_max, z_min, z_max, rho1_min, rho1_max, rho2_min, rho2_max, flag = 10.0f0, 15.0f0, 0.2f0, 0.25f0, -1.0f0, -0.9f0, 0.1f0, 100.0f0, 2
...
t = @elapsed begin
    ...
    test_profile(RMIN, RMAX, NBINS, Rv_min, Rv_max, z_min, z_max, rho1_min, rho1_max, rho2_min, rho2_max, flag, lensname, tracname)
end
