...
const Rv_min, Rv_max, z_min, z_max, rho1_min, rho1_max, rho2_min, rho2_max, flag = 0.0, 50.0, 0.1, 0.4, -1.0f0, -0.9f0, -1.0, 100.0f0, 2
...
t = @elapsed begin
    ...
    @threads calculate_all_indiv(RMIN, RMAX, NBINS, Rv_min, Rv_max, z_min, z_max, rho1_min, rho1_max, rho2_min, rho2_max, flag, lensname, tracname)
end
